 ...
 */
final class Version20240417082107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD statut VARCHAR(50) NOT NULL, DROP status');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD status JSON NOT NULL, DROP statut');
