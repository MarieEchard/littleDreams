 ...
 */
final class Version20240503122850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE paiements paiements DOUBLE PRECISION DEFAULT NULL, CHANGE reste_apayer reste_apayer DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE paiements paiements DOUBLE PRECISION NOT NULL, CHANGE reste_apayer reste_apayer DOUBLE PRECISION NOT NULL');
