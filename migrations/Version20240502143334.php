 ...
 */
final class Version20240502143334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous CHANGE projet_id projet_id INT DEFAULT NULL');
        }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous CHANGE projet_id projet_id INT NOT NULL');
