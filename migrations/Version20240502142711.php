 ...
 */
final class Version20240502142711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD statut VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE rendez_vous ADD statut VARCHAR(50) NOT NULL, CHANGE raison raison VARCHAR(1000) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous DROP statut, CHANGE raison raison VARCHAR(255) NOT NULL');
